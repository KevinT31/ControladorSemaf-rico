...
temporización de las luces. Los esquemas convencionales operan con planes de tiempo fijo o con control
...
saturación (Zhang et al., 2021). Su valor reside en la interpretabilidad y la simplicidad analítica para
...
estrategias convencionales en casos de estudio reales. Esta combinación de mejora cuantificable,
interpretabilidad y validabilidad fundamenta la elección de la lógica difusa como núcleo del control
adaptativo de la solución propuesta.

El aprendizaje por refuerzo profundo (DRL), que aprende políticas mediante interacción continua con el
entorno y alcanza mejoras competitivas en redes complejas, se considera una línea de trabajo futuro:
requiere grandes volúmenes de datos y entrenamiento, presenta inestabilidad durante el aprendizaje y, sobre
todo, una baja interpretabilidad que dificulta su validación para operación crítica. Por ello se reserva como
capa experimental de optimización global, sin sustituir al control difuso local validable.
...
manual cuidadosa para reflejar condiciones reales.
