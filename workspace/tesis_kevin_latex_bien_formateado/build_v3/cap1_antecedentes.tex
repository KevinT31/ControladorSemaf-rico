...
La VDI 2221 guía el proceso desde la clarificación de la tarea hasta el diseño conceptual, la selección de
alternativas y el desarrollo de detalle. A partir de la revisión del estado del arte se construye la
estructura de funciones, se plantean alternativas de solución y se selecciona una solución óptima mediante
evaluación técnica y económica. La VDI 2206 se incorpora en las etapas de integración del sistema
mecatrónico, donde se relacionan el diseño mecánico del gabinete y soporte, el diseño electrónico de
alimentación y procesamiento, el algoritmo de control, la comunicación con la nube y la validación mediante
simulación, verificando que las decisiones de diseño se analicen como parte de una arquitectura completa y
coherente.
