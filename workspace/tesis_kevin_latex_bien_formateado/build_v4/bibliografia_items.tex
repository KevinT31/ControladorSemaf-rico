...
\item
  Ault, J., \& Sharon, G. (2021). Reinforcement learning benchmarks for traffic signal control. \emph{Proceedings of the Thirty-fifth Conference on Neural Information Processing Systems (NeurIPS 2021), Datasets and Benchmarks Track}. \url{https://openreview.net/pdf?id=LqRSh6V0vR}
\item
...
\item
  Mei, H., Lei, X., Da, L., Shi, B., \& Wei, H. (2023). LibSignal: An open library for traffic signal control. \emph{Machine Learning}. \url{https://doi.org/10.1007/s10994-023-06412-y}
\item
...
\item
  Xu, T., Barman, S., \& Levin, M. W. (2024). Smoothing-MP: A novel max-pressure signal control considering signal coordination to smooth traffic in urban networks. \emph{Transportation Research Part C: Emerging Technologies, 166}, 104760. \url{https://doi.org/10.1016/j.trc.2024.104760}
\item
