...
El sistema de desplazamiento de la cámara sobre rieles requiere un actuador con posicionamiento preciso y
repetible y torque suficiente frente a vibraciones. Se evaluaron motor DC, servomotor y motor paso a paso,
...
\subsection{Unidad de control y aceleración de IA}\label{subsec:unidad-control}
...
baterías. La autonomía de 72\,min es suficiente para un registro y apagado controlados.
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}p{7.5cm}cr@{}}
    ...
    \midrule
    \textbf{Total estimado del módulo electrónico} & & \textbf{$\approx$ 6\,485}\\
    \bottomrule
  \end{tabular}
