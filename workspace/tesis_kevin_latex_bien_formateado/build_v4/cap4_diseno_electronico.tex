...
\subsection{PCB de control e interfaces del módulo IoT}

El esquemático de la PCB de control e interfaces del módulo (Figura~\ref{fig:esq-controlador}) integra las interfaces que conectan
...
\begin{figure}[H]
  ...
  \caption{Esquemático de la PCB de control e interfaces del módulo IoT.}
...
\begin{figure}[H]
  ...
  \caption{PCB de control e interfaces del módulo IoT (diseño, sin verificación de manufactura).}
