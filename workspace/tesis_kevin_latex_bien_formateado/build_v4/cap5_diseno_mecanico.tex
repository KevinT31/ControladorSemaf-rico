...
\begin{figure}[H]
  ...
  \caption{Vista del módulo IoT complementario instalado en una intersección vehicular.}
...
\begin{figure}[H]
  ...
  \caption{Vista general del módulo IoT propuesto.}
...
\paragraph{Finalidad funcional del sistema de orientación.} El sistema de movimiento de la cámara materializa físicamente la estrategia de percepción activa definida en la arquitectura de control (Sección~\ref{subsec:percepcion-activa}). Su propósito no se agota en habilitar el giro mecánico del sensor: persigue que la orientación Norte--Sur o Este--Oeste se alcance de forma repetible y estable, con la rigidez necesaria para no deteriorar la captura de imágenes en la fase de observación.
...
\begin{itemize}
  ...
  \item \textbf{Nivel 3 (intermedio-inferior) -- Respaldo energético:} interfaz de baterías y gestión del UPS APC SMT1500IC (1500\,VA/1000\,W, 2$\times$12\,V/12\,Ah, 72~min de autonomía; Capítulo~\ref{cap:diseno-electronico}), con conmutación $<10$~ms. La unidad UPS, de formato torre, se instala en la base del poste; en el rack se aloja únicamente esta interfaz (3.5~kg), cuya posición inferior contribuye a mantener bajo el centro de masa.
...
\section{Soporte del módulo IoT complementario}\label{sec:soporte-controlador}

El soporte fija el gabinete a 4.8~m de altura sobre el nivel del terreno mediante un poste tubular de acero (Figura~\ref{fig:conexion-poste}). El peso total del conjunto genera una carga vertical de $W = 47.126 \times 9.81 = 462$~N, que se adopta \emph{íntegra} como carga vertical de diseño ($W_{\text{diseño}} = 462$~N), sin descontar componentes removibles. Como se muestra a continuación, esta carga gravitatoria resulta de todos modos insignificante frente a la capacidad del poste: el dimensionamiento lo gobiernan las cargas laterales de viento y la rigidez (deflexiones), no la compresión axial.
...
El aire se calienta solo 2.5\,°C al atravesar el gabinete a caudal nominal. En el caso más desfavorable de temperatura ambiente de 60\,°C, el aire expulsado alcanzaría $\approx 62.5$\,°C y la temperatura interna promedio rondaría los 61\,°C. Este valor se mantiene dentro del rango de la mayoría de los componentes (SBC, módulo 4G y fuentes de potencia), pero \textbf{excede el máximo nominal del \emph{driver} DM542T ($+45$\,°C)}; por ello, para un despliegue de campo con ambiente extremo debe adoptarse el \emph{driver} de rango industrial o el acondicionamiento térmico activo señalados en el Capítulo~\ref{cap:diseno-electronico}, requisitos que se verificarán en el banco de prototipo. En las condiciones ambientales típicas de Lima (máximas cercanas a 30\,°C), la temperatura interna estimada ($\approx 32.5$\,°C) queda holgadamente dentro del rango de todos los componentes, incluido el \emph{driver}.
...
\begin{enumerate}
  ...
  \item \textbf{Poste y soporte del módulo IoT:} perfil tubular de acero A36 (130$\times$130$\times$10~mm), refuerzos triangulares superiores e inferiores y placa base.
