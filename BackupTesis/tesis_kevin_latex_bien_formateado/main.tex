...
\vspace{1.25cm}
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{media/image155.png}
\end{center}\par
\vspace{1.1cm}
{\Large\bfseries 2025 -- 2\par}
\vspace{0.9cm}
{\large\bfseries DISEÑO DE UN SISTEMA DE CONTROL ADAPTATIVO INTELIGENTE DE LA RED SEMAFÓRICA VIAL QUE INCLUYE COMUNICACIÓN CON LA NUBE Y SEGURIDAD CIBERNÉTICA\par}
\vspace{1.1cm}
{\large\bfseries Trabajo de Fin de Carrera 2\par}
\vspace{0.85cm}
{\large Autor:\par}
\vspace{0.2cm}
...
\vfill
{\large\bfseries Entrega Final - TFC2\par}
\vspace{0.65cm}
...
Este trabajo propone el diseño de un sistema de control semafórico adaptativo inteligente, orientado a intersecciones urbanas de Lima Metropolitana. El sistema permite ajustar los ciclos semafóricos en tiempo real mediante el uso de visión por computadora, control difuso local y aprendizaje por refuerzo en la nube, todo gestionado por un módulo IoT con comunicación mediante redes. Esta arquitectura híbrida, reforzada con medidas de ciberseguridad y capacidad de operación autónoma ante pérdidas de conectividad, busca reducir la congestión vehicular general y la de los vehículos de emergencia, los tiempos de espera y las emisiones contaminantes.

La validación experimental mediante simulación microscópica en SUMO con escenarios calibrados de Lima mostró mejoras en indicadores de desempeño de tráfico. El análisis económico mostró una inversión por intersección considerablemente menor que sistemas adaptativos comerciales tradicionales.

La propuesta se desarrolla siguiendo la metodología VDI 2221 complementada por Design Thinking, y considera explícitamente la fragmentación tecnológica actual del sistema semafórico limeño. Esta investigación sienta las bases para una futura implementación piloto escalable y distribuida, capaz de operar en un entorno urbano heterogéneo en marcas y protocolos como el nuestro, incluyendo funcionalidades avanzadas como coordinación de olas verdes para vehículos de emergencia y predicción proactiva de congestión.

\textbf{Palabras clave:} congestión vehicular, sistema semafórico adaptativo, IoT, nube, ciberseguridad, control inteligente, VDI 2221, aprendizaje por refuerzo, visión por computadora.
...
La congestión vehicular en Lima Metropolitana es uno de los problemas más críticos que están afectando a millones de personas cada día. Un informe publicado por El Comercio en el año 2024 indica que Lima se ha convertido en la ciudad con mayor número de congestión vehicular en América latina, con una velocidad promedio de 14.5 km/h. No solo se trata de una cantidad impresionante de tiempo desperdiciado para los conductores: el costo de la congestión se estima en aproximadamente el 1.8\% del PBI de Perú, según el Banco Mundial. Por otra parte, el transporte está generando cerca del 40\% de las emisiones metropolitanas de gases tóxicos (Banco Mundial, 2024) lo que se puede representar como una contribución mayor a la contaminación atmosférica metropolitana.
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image149.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image116.png}
...
\section{Objetivos del Proyecto de Tesis}\label{objetivos-del-proyecto-de-tesis}

\subsection{Objetivo general}\label{objetivo-general}

Diseñar un sistema de control adaptativo basado en IoT que funcione como módulo complementario al controlador semafórico existente, integrando visión por computadora, algoritmos de inteligencia artificial y comunicación segura en la nube para optimizar el flujo vehicular en intersecciones urbanas.
...
\item
  Desarrollar un algoritmo adaptativo basado en aprendizaje por refuerzo y lógica difusa para ajustar dinámicamente los ciclos semafóricos según las condiciones del tráfico en tiempo real, integrando un sistema de visión por computadora para detectar vehículos, junto con una infraestructura en la nube que incluya medidas de ciberseguridad.
\item
...
El presente proyecto de tesis se enfoca en el desarrollo de un sistema de control adaptativo inteligente para la red semafórica vial de Lima, con el objetivo de optimizar la gestión del tráfico en tiempo real mediante la integración de tecnologías IoT, inteligencia artificial y ciberseguridad. En esta fase inicial, el alcance se limita al diseño conceptual y la simulación de los componentes del sistema propuesto, sin llegar a su implementación física en las intersecciones de la ciudad.

Se llevará a cabo el diseño conceptual completo del sistema de semaforización inteligente propuesto. Esto incluye la definición general de la arquitectura de hardware y software, los componentes de IoT, los algoritmos de control y las medidas de ciberseguridad.

La implementación física del sistema en campo no forma parte de TFC1. En consecuencia, no se instalarán sensores ni controladores en intersecciones reales durante esta etapa. Tampoco se desarrollará hardware específico. Tampoco se realizarán pruebas de campo ni validaciones a gran escala en tráfico real. Las conclusiones se basarán en datos recolectados, que si bien son indicativos, requieren confirmación posterior en condiciones reales.

Algunos componentes secundarios, como la integración con sistemas de semáforos existentes de Lima (compatibilidad con controladores actuales) o la interfaz completa para operadores de tránsito, no serán desarrollados en TFC1.

En cuanto a ciberseguridad, el sistema no implementará aún un sistema integral de defensa con todas sus capas. Se limitará a un diseño conceptual de seguridad y se probarán aspectos puntuales. La certificación formal de seguridad queda fuera del alcance inmediato.

Finalmente, el alcance geográfico del estudio se mantendrá focalizado. En esta fase, no se abarcará toda la ciudad de Lima, sino algún cruce representativo como prueba de concepto. La extrapolación a toda la red vial es un objetivo a largo plazo que requerirá mayores recursos computacionales y una complejidad que escapa a TFC1.

\section{Metodología empleada}\label{metodologuxeda-empleada}

Para el desarrollo del presente trabajo de tesis, se utilizará la metodología VDI 2221 como marco principal, complementada con elementos de VDI 2206 para el diseño de sistemas mecatrónicos que integran mecánica, electrónica, control e informática. Esta combinación permite un enfoque sistemático y multidisciplinario, adecuado para el desarrollo de un controlador adaptativo de tráfico basado en IoT, con énfasis en la integración modular, el procesamiento en tiempo real y la validación iterativa.

La metodología VDI 2221 guía el proceso desde la clarificación de la tarea hasta el diseño detallado, mientras que VDI 2206 incorpora ciclos de iteración para sistemas adaptativos. La primera etapa consiste en identificar la problemática, justificándose con cifras y evidenciando la necesidad de abordarla. Para este caso, se sustenta la congestión vial en Lima utilizando reportes e informes de entidades como el Ministerio de Transportes y Comunicaciones (MTC), la Autoridad de Transporte Urbano para Lima y Callao (ATU) y el Instituto Nacional de Estadística e Informática (INEI) sobre impactos en tiempo perdido, emisiones y accidentes. Se complementa con datos como flujos vehiculares promedio, tiempos de espera y colas vehiculares. Seguidamente, se establecen los objetivos generales y específicos de la tesis. El objetivo general describe el propósito integral del controlador adaptativo, mientras que los objetivos específicos detallan los pasos secuenciales para su concreción. A continuación, se delimita el alcance, especificando que el sistema abarcará el diseño modular (lógico y de potencia) clásico en Controladores estándar, integración con controladores existentes vía NTCIP, procesamiento local con una placa de microordenador (incluyendo visión por computadora y algoritmos de IA), comunicación con Azure y validación en simulaciones, pero excluyendo la fabricación física o despliegue en campo real (reservado para fases futuras). Posteriormente, se investiga el estado del arte. Por una parte, se buscan patentes relacionadas al control adaptativo de tráfico, con el fin de identificar arquitecturas modulares, algoritmos de optimización, mecanismos de visión y protocolos de comunicación (NTCIP/MQTT), validando estas soluciones con productos existentes. Del mismo modo, se explora información sobre detección vehicular en tiempo real, estimación de colas, integración en la nube y medidas de ciberseguridad en entornos IoT urbanos.
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image25.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image47.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image17.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image43.png}
...
Los mecanismos de control adaptativo actuales demuestran que es posible optimizar dinámicamente la operación de redes semafóricas, ya sea mediante estrategias centralizadas o descentralizadas. Para el diseño del módulo IoT propuesto, se deriva que una arquitectura híbrida podría aprovechar ventajas de ambos enfoques: por ejemplo, procesar datos localmente en cada intersección (inteligencia en el borde) asegurando respuesta rápida, y a la vez comunicar información al nivel de nube para coordinar múltiples intersecciones y obtener una optimización global del corredor vial. Asimismo, cualquier controlador IoT diseñado debe ser compatible con la infraestructura existente, pudiendo integrarse a controladores de tráfico estándares (mediante protocolos comunes) o incluso reemplazarlos parcialmente, garantizando siempre los requerimientos de seguridad funcional. La sección destaca además la importancia de incorporar algoritmos adaptativos inteligentes en el módulo IoT por ejemplo, algoritmos de planificación multi-agente como Surtrac o técnicas de optimización en tiempo real basadas en IA para superar las limitaciones de los sistemas tradicionales.
...
La comunicación con la nube permite que datos en tiempo real (conteos de vehículos, estados de semáforo, fallos, etc.) sean enviados a servidores centralizados donde se pueden aplicar algoritmos más intensivos de optimización o almacenamiento histórico. A su vez, desde la nube se pueden desplegar configuraciones o comandos a los semáforos en campo.
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image82.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image127.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image132.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image144.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image45.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image91.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image154.jpg}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image27.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image74.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image83.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image80.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image147.png}
...
La captura de imágenes es realizada por la cámara Raspberry Pi V2 IMX219 de 8 megapíxeles, que proporciona imágenes de 3280 x 2464 píxeles con formatos de vídeo que incluyen 1080p30 y 720p60. Esta cámara cuenta con un campo de visión de 62.2° x 48.8° e interfaz CSI (Camera Serial Interface), facilitando el análisis visual del flujo vehicular y la detección de vehículos de emergencia. El sistema está posicionado estratégicamente en el centro de la intersección sobre un soporte de dos grados de libertad controlado por dos servomotores, velocidad de operación de 0.1s/60°, torque mínimo de 2.5kg-cm, voltaje de operación de 4.8V a 6V DC y control PWM (Pulse Width Modulation). Cabe mencionar que la altura de 6.5 metros brindará una visualización de la zona de interés de la intersección. Esta configuración asegura cobertura total de la intersección y proporciona control del movimiento de la cámara para seguimiento de vehículos de emergencia hacia sus destinos respectivos.

El control de las luces semafóricas se implementa mediante relés de estado sólido (SSR) que ofrecen conmutación silenciosa y sin desgaste mecánico, mejorando la fiabilidad y durabilidad del sistema. La iluminación de las luces semafóricas se logra mediante un sistema de fibra óptica LED que permite una distribución uniforme de la luz, generando la iluminación desde la base del controlador y transmitiendola por fibra óptica hacia los focos semafóricos, lo que resulta en un mantenimiento más accesible.
...
El procesamiento local se implementa utilizando técnicas de procesamiento de imágenes con OpenCV y Yolo ejecutándose en el Raspberry Pi, permitiendo análisis en tiempo real del flujo vehicular, detección automática de vehículos de emergencia, cálculo de velocidades promedio y medición de colas vehiculares. El acondicionamiento de datos se realiza mediante procesos ETL (Extract, Transform, Load) que preparan la información para su transmisión en formato CSV hacia la central semafórica. El análisis de datos en la nube se ejecuta en la plataforma Microsoft Azure utilizando Apache Spark, facilitando el procesamiento y análisis de grandes volúmenes de datos para la toma de decisiones informadas y la generación óptima de ciclos de luces de manera global.
...
La optimización de ciclos semafóricos se genera mediante algoritmos globales ejecutados desde la nube, considerando datos locales de tráfico, información de la API de Google Maps y patrones históricos de congestión. El monitoreo continuo del sistema recolecta todos los datos con fecha y hora precisas, almacenándose en la nube. El bosquejo del diseño se aprecia en la figura 47.

\begin{quote}
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image140.png}
\end{center}
\end{quote}

\subparagraph{Figura 19. Bosquejo del diseño de la Solución Óptima (Creación propia).}\label{figura-19.-bosquejo-del-diseuxf1o-de-la-soluciuxf3n-uxf3ptima-creaciuxf3n-propia.}

En la figura 48 se puede apreciar el diagrama general de flujo del sistema semafórico. El controlador estándar, que actúa como el encargado de accionar directamente los semáforos, está conectado a cada uno de ellos mediante el protocolo NTCIP sobre TCP/IP, asegurando el cumplimiento de las fases y tiempos programados. A su vez, este controlador recibe información y comandos desde un módulo de sensoreado y control adaptativo local, es decir, un módulo IoT instalado en la intersección, que recopila datos del entorno y se comunica con la nube mediante MQTT sobre TCP/IP.

La nube desempeña un rol de control adaptativo global, accediendo a los datos que le envían los distintos módulos IoT distribuidos en las intersecciones para calcular estrategias de coordinación más eficientes. Esta nube se encuentra conectada a la central semafórica supervisora, la cual también mantiene comunicación directa con el controlador programable de tráfico, recibiendo datos detallados y visuales mediante fibra óptica.
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image49.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image13.png}
...
El sistema se estructura en torno a dos núcleos de procesamiento Raspberry Pi 5, uno dedicado como CPU principal para control y gestión, y otro como GPU especializado en procesamiento de imágenes. Este controlador se conecta con la Nube Azure para un posterior análisis y optimización global de ciclos semafóricos. La alimentación eléctrica parte de la Red Eléctrica 220V AC, protegida por Llaves Termomagnéticas y Disyuntores, convertida mediante Fuente Conmutada AC/DC 24V, complementada con Batería DC de respaldo y Convertidores DC/DC para voltajes específicos de cada componente.
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image151.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image89.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image120.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image75.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image28.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image150.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image15.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image110.png}
...
\begin{center}
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image93.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image60.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image85.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image157.png}
...
\begin{center}
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image88.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image139.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image54.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image153.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image20.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image68.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image21.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image86.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image87.png}
...
\(Potencia_{Salida\ DC\  - \ 5} = 50\ W\ x\ 0.815\  = \ 40.75\ W\) (1)
...
\(Potencia_{Entrada\ DC - DC} = P_{5v}\ /\ n_{5v}\  + \ P_{12v}\ /\ n_{12v}\  = \ 56.86\ W\) (2)

Sumado al consumo directo en 24 V la potencia total requerida en 24 V es:

\(P_{24v} = 108\ W\ x\ 1.25\  + 56.86\ W\  = 191.86\ W\) (3)
...
\(P_{\text{pérdidas-SMPS}} = 191.86\ x\ (1 - 0.84)/0.84\  = \ 36.54\ W\) (3)

La SMPS operará a:

\(Carga_{Relativa} = 191.86\ /\ 360\  = 53.3\%\ de\ su\ capacidad\) (4)

\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image114.png}
...
\(Potencia_{AC - Entrada} = 191.86\ W\  \div \ 0.85\  = \ 228.4\ W\) (1)

\(Corriente{}_{AC} = 228.4\ W\  \div \ 220V\  = \ 1.04\ A\) (2)
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image6.png}
...
\(Capacidad_{\text{batería}} = 2\ x\ 12V\ x\ 12Ah\  = 288\ Wh\) (3)

\(Potencia_{Disponible} = 288\ Wh\ x\ 0.95\  = 273.6\ Wh\) (4)

Calculamos el tiempo de autonomía usando el dato de potencia (1):

\(Tiempo_{\text{autonomía}} = 273.6\ Wh\  \div \ 228.4\ Wh\  = 72\ min\ \) (5)

Margen del UPS (1000 W sobre 228.4 W):

\(Margen = 1000\ /\ 228.4\  = 4.38\) (6)
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image72.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image56.png}
...
\begin{center}
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image136.png}
\end{center}
...
\begin{center}
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image101.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image35.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image40.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image44.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image107.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image126.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image148.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image24.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image2.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image22.png}
...
\strut \\
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image117.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image77.png}
...
\begin{center}
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image69.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image8.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image97.png}
...
\begin{center}
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image11.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image30.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image64.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image111.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image109.png}
...
\(Volumen\ exterior = 0.479\ x\ 0.6\ x\ 0.525\  = \ 0.1509\ m\ensuremath{^{3}}\ \) (1)
...
\(Volumen\ interior = 0.473\ x\ 0.588\ x\ 0.513\  = \ 0.1427\ m\ensuremath{^{3}}\ \) (2)

El volumen de material del gabinete se obtiene como:

\(V_{Material} = 0.1509\  - 0.1427\  = \ 0.0082\ m\ensuremath{^{3}}\ \) (3)

La masa del gabinete, usando (3) y la densidad mencionada con anterioridad resulta:

\(m_{gabinete} = 2680\ kg/m\ensuremath{^{3}}\ x\ 0.0082\  = \ 21.976\ \ kg\ \) (4)
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image145.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image84.png}
\end{center}

\subparagraph{Figura 70 . PCB Distribuidor de Voltaje}\label{figura-70-.-pcb-distribuidor-de-voltaje}

\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image70.png}
...
\begin{center}
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image14.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image57.png}
\end{center}

\subparagraph{Figura 73 . UPS y SMPS}\label{figura-73-.-ups-y-smps}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image79.png}
\end{center}

\subparagraph{Figura 74 . Componentes de protección y DC DC}\label{figura-74-.-componentes-de-protecciuxf3n-y-dc-dc}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image16.png}
...
\(m_{total} = m_{gabinete}\  + \ m_{rack}\  + m_{aro}\ {+ m}_{sistema\ movimiento}\  + \ m_{accesorios} = \ 47.126\ kg\ \) (1)
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image42.png}
...
\begin{center}
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image37.png}
\end{center}
...
\begin{center}
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image51.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image125.png}
...
\(\Sigma Fy\  = \ 0:\ Gy\  - \ Wa\  - \ Wr\  - \ Ws\  - \ Wc\  - \ componente\ vertical\ de\ B\  = \ 0\ \ \) (1)

\(Gy\  = \ 76.52\  + \ 9.81\  + \ 0.49\  + \ 5.89\  + \ B \cdot sen(\theta)\ \ \ \) (2)

\(Gy\  \approx \ 92.71\ N\  + \ B \cdot sen(\theta)\ \ \ \) (3)

Donde \ensuremath{\theta} es el ángulo instantáneo de la biela respecto a la horizontal.

Equilibrio horizontal:

\(\Sigma Fx\  = \ 0:\ Gx\  - \ FR\  - \ componente\ horizontal\ de\ B\  = \ 0\ \ \) (4)

\(Gx\  = \ FR\  + \ B \cdot cos(\theta)\ (2)\ \ \ \) (5)

La cámara se apoya sobre el soporte mediante dos puntos de contacto (NC1, NC2). El equilibrio vertical requiere:

\(\Sigma Fy\  = \ 0:\ NC1\  + \ NC2\  - \ Wc\  - \ Ws\  = \ 0\ \ \) (6)

\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ NC1\  + \ NC2\  = \ 5.89\  + \ 0.49\  = \ 6.38\ N\) (7)
...
\(W_{\text{diseño}}\  = \ FS\  \times \ (Ws + Wc)\  = \ 2.0\  \times \ 6.38\ N\  = \ 12.76\ N\ \ \) (1)
...
\(T_{\text{fricción}}\  = \ \mu_{\text{rodamiento}}\ \times \ W_{\text{diseño}}\  \times \ r\ \ \ \ \) (2)

\(T_{\text{fricción}}\  = \ 0.002\  \times \ 12.76\ N\  \times \ 0.060\ m\  \approx \ 1.53\ mN \cdot m\ \ \) (3)
...
\(T_{Inercial\ } = \ \ I\  \times \ \alpha\  = \ 0.012\  \times \ 0.5\  = \ 0.006\ N \cdot m\  = \ 6\ mN \cdot m\ \ \) (4)

\(T_{\text{dinámico}}\  = \ \ T_{\text{fricción}}\  + \ T_{inercial}\  = \ 1.53\  + \ 6\  = \ 7.53\ mN \cdot m\ \) (5)

\({FS}_{Motor\ } = \ T_{nominal}\ /\ T_{\text{dinámico}} = \ 1.8\ N \cdot m\ /\ 0.00753\ N \cdot m\  = \ 239\ \ \) (6)
...
\({\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \sigma}_{biela} = F_{biela}/A\  = 0.1N\ /\ 350\ mm^{2}\  = \ 2.86\  \times \ 10\ensuremath{^{-4}}\ MPa\)\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (4)\)
...
\begin{equation*}
FS_{Material} = \frac{\sigma_{\text{tracción}}}{\sigma_{biela}} = \frac{228~\text{MPa}}{2.86 \times 10^{-4}~\text{MPa}} \approx 7.97\times 10^{5}
\end{equation*}

\begin{equation*}
\text{Utilización} = \frac{2.86 \times 10^{-4}}{228} \times 100\% \approx 0.00013\%
\end{equation*}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image73.png}
...
\(\ \ \ \ \ \ \ \ \ P_{out} = 24V\  \times \ 15A\  = \ 360W\)\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (1)\ \)

Pérdidas:

\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ P_{\text{pérdidas SMPS}} = P_{out}\ x\ (1 - n)/n\  = 360\ x\ (1 - 0.85)/0.85\)\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (2)\ \)

\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ P_{\text{pérdidas SMPS}} = 63.5\ W\)\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (3)\ \)

\textbf{UPS 500VA (operación float charging, eficiencia 92\%):}

\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ P_{\text{pérdidas UPS}} = 500\ x\ 0.08\  = \ 40\ W\ (En\ modo\ recarga)\)\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (4)\ \)

\textbf{Driver DM542T (operación motor a 3A, eficiencia 90\%):}

Potencia entregada al motor:

\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ P_{motor} = 24V\  \times \ 3A\  \times \ 2\ fases\  = \ 144W\)\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (5)\ \)

\(\ \ \ \ \ \ \ P_{\text{pérdidas driver}} = \ 144\  \times \ (1\  - \ 0.90)\ /\ 0.90\  = \ 16W\)\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (6)\ \)
...
\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ P_{\text{pérdidas conversores}} = \ (5V\  \times \ 3A\  + \ 12V\  \times \ 2A)\  \times \ 0.15\ /\ 0.85\  = \ 8.4W\)\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (9)\ \)

\textbf{Potencia térmica total disipada (usando (1) al (9)):}

\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Q_{TOTAL}\  = \ 63.5\  + \ 40\  + \ 16\  + \ 15\  + \ 5\  + \ 8.4\  = \ 147.9\ W\  \approx \ 150W\)\(\ \ \ \ \ \ \ \ \ \ \ \ \)
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image29.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image104.png}
...
\(\ \ \ \ \ \ \ \ \ Wgabinete\  = \ 47.126\ kg\  \times \ 9.81\ m/s\ensuremath{^{2}}\  = 462\ N\)\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (1)\ \)
...
\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ W_{\text{diseño}}\  = \ 35\ kg\  \times \ 9.81\ m/s\ensuremath{^{2}}\  = \ 343.4\ N\  \approx \ 350\ N\)\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (2)\ \)
...
\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ A\  = \ (130\ensuremath{^{2}})\  - \ (110\ensuremath{^{2}})\  = \ 16,900\  - \ 12,100\  = \ 4,800\ mm\ensuremath{^{2}}\)\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (3)\ \)

\textbf{Propiedades geométricas de la sección:}

Momento de inercia de sección cuadrada hueca respecto a ejes principales:

\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ I\  = \ (b\ensuremath{_{4}}\ensuremath{^{4}}\  - \ b\ensuremath{_{1}}\ensuremath{^{4}})/12\  = \ (130\ensuremath{^{4}}\  - \ 110\ensuremath{^{4}})/12\)\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (4)\ \)

\(\ \ \ \ \ \ \ \ \ \ \ \ \ I\  = \ 11,600,000\ mm\ensuremath{^{4}}\ \)\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (5)\ \)

Módulo de sección elástico:

\(\ \ \ \ \ \ \ \ \ \ \ \ \ W\  = \ I/(b/2)\  = \ 11,600,000/(130/2)\  = \ 178,462\ mm\ensuremath{^{3}}\ \)\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (6)\ \)

Radio de giro:

\(\ \ \ \ \ \ \ \ \ \ \ \ \ r\  = \ \sqrt{}(I/A)\  = \ \sqrt{}(11,600,000/4,800)\  = \ \sqrt{}2,417\  = \ 49.2\ mm\ \)\(\ \ \ \ \ \ \ \ \ \ \ (7)\ \)
...
\(\ \ \ \ \ \ \ \ \ \ W_{\text{diseño}}\ /\ A\  = \ 350\ N\ /\ 4,800\ mm\ensuremath{^{2}}\  = \ 0.073\ N/mm\ensuremath{^{2}}\  = \ 0.073\ MPa\ \)\(\ \ \ \ \ \ (8)\ \)

Factor de seguridad respecto a fluencia del material:

\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ FS_{\text{compresión}}\  = \ f_{y}\ /\ \sigma_{\text{compresión}}\  = \ 250\ MPa\ /\ 0.073\ MPa\  = \ 3{,}425\ \)\(\ \ \ \ \ \ (9)\ \)
...
\(\ \ \ \ \ \ \ \ \ \ \ \ \ e\  = \ 273.2\ mm\  - \ 110\ mm\  = \ 163.2\ mm\  \approx \ 160\ mm\ \)\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (10)\ \)

Esta excentricidad reducida amortigua el momento flector adicional generado por el peso del gabinete:

\(\ \ \ \ \ \ \ \ \ \ \ \ \ M_{\text{excentricidad}}\  = \ W_{\text{diseño}}\  \times \ e\  = \ 350\ N\  \times \ 0.160\ m\  = \ 56\ N \cdot m\ \)\(\ \ \ \ \ \ \ \ \ \ \ (11)\ \)
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image55.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image159.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image90.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image96.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image134.png}
...
\begin{center}
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image31.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image100.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image141.png}
...
\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \lambda p\  = \ 1.12\  \times \ \sqrt{}(E/fy)\  = \ 1.12\  \times \ \sqrt{}(200,000/250)\  = \  \approx \ 31.7\)\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (2)\)
...
\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ FS_{Material\ } = fy\ /\ \sigma_{\text{compresión}} = 250\ MPa\ /\ 70.52\ MPa\  = \ 3.545\ \) (3)
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image61.png}
...
\begin{center}
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image99.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image130.png}
...
\begin{center}
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image1.png}
\end{center}
...
\textbf{2. Subsistema de Decisión mediante Aprendizaje por Refuerzo Híbrido}

Emplea algoritmos de Reinforcement Learning que aprenden políticas de control óptimas mediante interacción con el entorno simulado. La arquitectura híbrida integra lógica difusa para manejar la incertidumbre inherente a las mediciones sensoriales y proporcionar respuestas interpretables que facilitan la validación del sistema por operadores humanos.

\textbf{3. Infraestructura de Comunicación en la Nube}

Facilita la coordinación entre múltiples intersecciones mediante procesamiento centralizado de datos agregados, permitiendo optimizaciones de red que consideran efectos de propagación de congestión y olas verdes coordinadas. La plataforma Microsoft Azure ejecuta análisis de Big Data utilizando Apache Spark para identificar patrones históricos y generar estrategias de control globalmente óptimas.
...
\begin{equation}
V_{mov}(l,t) = \{\, v \in V(l,t) : velocidad(v) \geq \varepsilon \,\}, \qquad N_{mov}(l,t) = \left| V_{mov}(l,t) \right|
\end{equation}
...
Donde \(N_{cross}(l,\,t_{0},\,t)\) es el número de vehículos que cruzaron una línea de conteo virtual en el carril \(l\) entre los tiempos \(t_{0}\) y \(t\), calculado con YOLO.
...
\begin{itemize}
\item
  \(N_{total}(l,t) = \left| V(l,t) \right|:\) número total de vehículos detectados en el carril \(l\).
\item
...
\begin{equation}
ICV(l,t) = w_{1}\,\frac{SC(l,t)}{SC_{MAX}} \;+\; w_{2}\left(1 - \frac{V_{avg}(l,t)}{V_{MAX}}\right) \;+\; w_{3}\,\frac{k(l,t)}{k_{MAX}} \;+\; w_{4}\left(1 - \frac{q(l,t)}{q_{MAX}}\right)
\label{eq:icv}
\end{equation}
...
\begin{itemize}
\item
  \(w_{1}, w_{2}, w_{3}, w_{4}\): pesos de influencia, calibrados mediante datos históricos y aprendizaje automático. Como configuración inicial se adopta \(w_{1}=0.35\), \(w_{2}=0.25\), \(w_{3}=0.25\), \(w_{4}=0.15\), priorizando la cola detenida como el indicador más directo de demanda insatisfecha.
\end{itemize}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image95.png}
...
\subsection{Matriz de Estado Local para Transmisión}\label{matriz-de-estado-local-para-transmisiuxf3n}

La matriz de estado de la intersección \(I_{p}\) en el instante \(t\) consolida todas las variables de entrada normalizadas, y se transmite a la plataforma Azure para su procesamiento centralizado. Organizando las 7 variables (filas) por las 4 direcciones (columnas):

\begin{equation}
X_{local}^{(p)}(t) =
\begin{bmatrix}
SC_{N}(t) & SC_{S}(t) & SC_{E}(t) & SC_{O}(t)\\
V_{avg,N}(t) & V_{avg,S}(t) & V_{avg,E}(t) & V_{avg,O}(t)\\
q_{N}(t) & q_{S}(t) & q_{E}(t) & q_{O}(t)\\
k_{N}(t) & k_{S}(t) & k_{E}(t) & k_{O}(t)\\
ICV_{N}(t) & ICV_{S}(t) & ICV_{E}(t) & ICV_{O}(t)\\
PI_{N}(t) & PI_{S}(t) & PI_{E}(t) & PI_{O}(t)\\
EV_{N}(t) & EV_{S}(t) & EV_{E}(t) & EV_{O}(t)
\end{bmatrix}
\in \mathbb{R}^{7 \times 4}
\label{eq:xlocal}
\end{equation}
...
La normalización se realiza para escalar todas las variables a un rango común, normalmente \([0,1]\), garantizando que magnitudes con diferentes unidades tengan una influencia comparable dentro del controlador adaptativo o difuso. En este caso, la normalización se efectúa por variable y no sobre el vector total, aplicando el proceso a cada componente \(x_{i}\) de forma independiente. Vectorizando la matriz \(X_{local}^{(p)}\) en sus 28 componentes:

\begin{equation}
X_{local}(p,t) =
\begin{bmatrix}
x_{1}(t)\\ x_{2}(t)\\ \vdots\\ x_{28}(t)
\end{bmatrix}
\quad\Longrightarrow\quad
X_{local,norm}(p,t) =
\begin{bmatrix}
\dfrac{x_{1} - x_{1,\min}}{x_{1,\max} - x_{1,\min}}\\[8pt]
\dfrac{x_{2} - x_{2,\min}}{x_{2,\max} - x_{2,\min}}\\[4pt]
\vdots\\[4pt]
...
Esta matriz de 28 dimensiones (7 filas \ensuremath{\times} 4 columnas) representa el estado completo observable de la intersección y constituye la entrada al subsistema de decisión local y global.

\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image143.png}
...
\text{Paquete}_{p}(t) =
\begin{bmatrix}
ID_{\text{intersección}}\\
timestamp(t)\\
X_{local}^{(p)}(t)\\
\phi_{\text{actual}}^{(p)}(t)\\
T_{\text{restante}}^{(p)}(t)\\
estado_{\text{conexión}}\\
hash_{\text{integridad}}
\end{bmatrix}
\label{eq:paquete}
\end{equation}
...
\item
  \(hash_{integridad}\): Hash SHA-256 para validación de integridad del paquete.
\end{itemize}
...
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Cálculo de la matriz de adyacencia}: Las distancias euclidianas dij entre intersecciones se calculan una sola vez usando la fórmula de Haversine sobre las coordenadas almacenadas.
\item
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image50.png}
...
El estado global del sistema en el instante \(t\) se construye mediante la agregación de los estados locales transmitidos por todas las \(P\) intersecciones:
...
Esta matriz de alta dimensionalidad, donde \(P\) puede llegar a cientos de intersecciones en Lima Metropolitana, alimenta simultáneamente tres módulos de procesamiento desplegados en Azure.
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image112.png}
...
Evalúa el estado global mediante una política entrenada \ensuremath{\pi}*, genera acciones de control óptimas para cada intersección y predice la evolución futura del tráfico mediante arquitecturas CNN-LSTM. Este módulo integra las señales de priorización de emergencias con la optimización general de tráfico.
...
La matriz \(D\) es una matriz diagonal donde cada elemento \(D_{ii}\) representa la suma de todas las conexiones que tiene la intersección \(i\):
...
La matriz \(A_{norm}\) permite, por tanto, la modelación de propagación espacial de congestión, pues captura cómo los embotellamientos en una intersección se propagan a intersecciones vecinas mediante la ecuación de difusión:
...
Donde \(X \in \{\, QL,\ V_{avg},\ q,\ k,\ ICV,\ PI \,\}\). El signo y la magnitud de \(\Delta X_{red}\) permiten distinguir congestión en formación (\(\Delta ICV_{red} > 0\)) de congestión en disipación (\(\Delta ICV_{red} < 0\)), información que se incorpora al estado del agente de aprendizaje por refuerzo.
...
Para un corredor vial con \(n\) intersecciones consecutivas \(\{I_{1}, I_{2}, \ldots, I_{n}\}\) separadas por distancias \(\{d_{1}, d_{2}, \ldots, d_{n-1}\}\), el offset óptimo \(\tau_{i,i+1}^{*}\) entre intersecciones consecutivas se define como el desfase temporal que minimiza el número esperado de paradas vehiculares:

\begin{equation}
\tau_{i,i + 1}^{*} = \operatorname*{arg\,min}_{\tau \in [0,\ T_{ciclo})} P_{medio}(\tau)
\label{eq:offsetopt}
\end{equation}

Donde \(\tau\) es el desfase temporal entre los inicios de luz verde de dos intersecciones consecutivas y \(P_{medio}(\tau)\) es el número promedio de paradas que experimentan los vehículos en función del desfase elegido. El offset se restringe al rango \([0, T_{ciclo})\), siendo \(T_{ciclo}\) la duración total del ciclo semafórico.

El desfase debe ser tal que, si un vehículo parte de la primera intersección justo cuando el semáforo se pone verde y circula a una velocidad constante \(v_{prog}\), llegue a la siguiente intersección también cuando esta esté en verde, creando así una ``ola verde''. Consideremos un vehículo que sale de la intersección \(I_{i}\) en el instante \(t_{0}\) cuando inicia el verde. El tiempo que requiere para llegar a la intersección \(I_{i+1}\), distante \(d_{i}\) metros, es:

\begin{equation}
t_{viaje} = \frac{d_{i}}{v_{prog}}
\label{eq:tviaje}
\end{equation}
...
\begin{equation}
t_{verde}^{\,i + 1} = t_{0} + t_{viaje} + k \cdot T_{ciclo}, \qquad k \in \mathbb{Z}
\end{equation}

Donde \(k\) es el número de ciclos transcurridos. Dado que trabajamos con offsets dentro de un ciclo, aplicamos la operación módulo:

\begin{equation}
\tau_{i,i + 1} = t_{viaje} \bmod T_{ciclo} = \frac{d_{i}}{v_{prog}} \bmod T_{ciclo}
\label{eq:offset}
\end{equation}

Cabe recordar que \(d_{i}\) es la distancia entre dos intersecciones calculada con la fórmula de Haversine (Ecuación~\ref{eq:haversine}) sobre las coordenadas GPS de Cosmos DB, \(v_{prog}\) la velocidad de progresión y \(T_{ciclo}\) la duración del ciclo.

\subsubsection{Velocidad de Progresión Adaptativa}

La velocidad de progresión \(v_{prog}\) se calcula dinámicamente utilizando las velocidades transmitidas en \(X_{local}\) (desnormalizadas mediante \(V_{MAX}\)):

\begin{equation}
v_{prog} = \min\!\left(v_{limite},\ \frac{1}{n}\sum_{i = 1}^{n}V_{avg,\,corredor}^{(i)}(t) \cdot V_{MAX}\right)
\label{eq:vprog}
\end{equation}

Donde \(v_{limite}\) es la velocidad máxima legal del corredor, almacenada en Cosmos DB. El operador \(\min\) garantiza que la ola verde nunca se programe para una velocidad superior a la permitida, evitando incentivar excesos de velocidad.
...
\begin{equation}
BW_{verde} = \min_{i = 1, \ldots, n - 1}\left[\frac{T_{verde,i} - \left| \tau_{i,i + 1} - t_{viaje,i} \bmod T_{ciclo} \right|}{T_{ciclo}}\right]
\label{eq:bwverde}
\end{equation}

donde \(T_{verde,i}\) es determinado por el motor RL y el operador \(\min\) identifica el cuello de botella temporal del corredor: la intersección cuyo desajuste entre offset implementado y tiempo de viaje real más reduce la ventana de progresión.
...
\item
  Para cada par consecutivo en el corredor, se consultan las coordenadas GPS de Cosmos DB y se calcula d\ensuremath{_{i}} mediante la fórmula de Haversine.
\item
...
\item
  Se calcula BW\_verde para verificar que la configuración propuesta sea viable. Si BW\_verde \textless{} 0.3, el sistema incrementa progresivamente los tiempos verdes T\_verde,i hasta alcanzar un ancho de banda aceptable.
\item
  Los offsets calculados se incorporan en los comandos NTCIP que Azure transmite a cada intersección del corredor.
\end{enumerate}
...
Para cada dirección \(d \in \{N, S, E, O\}\), el ICV normalizado se mapea a tres conjuntos difusos:

\begin{equation}
\mu_{\text{Bajo}}(ICV) =
\begin{cases}
1, & \text{si } ICV \leq 0.2\\[3pt]
\dfrac{0.4 - ICV}{0.2}, & \text{si } 0.2 < ICV \leq 0.4\\[6pt]
0, & \text{si } ICV > 0.4
\end{cases}
\label{eq:mu-icv-bajo}
\end{equation}

\begin{equation}
\mu_{\text{Medio}}(ICV) =
\begin{cases}
0, & \text{si } ICV \leq 0.2\\[3pt]
\dfrac{ICV - 0.2}{0.2}, & \text{si } 0.2 < ICV \leq 0.4\\[6pt]
\dfrac{0.7 - ICV}{0.3}, & \text{si } 0.4 < ICV \leq 0.7\\[6pt]
0, & \text{si } ICV > 0.7
\end{cases}
\label{eq:mu-icv-medio}
\end{equation}

\begin{equation}
\mu_{\text{Alto}}(ICV) =
\begin{cases}
0, & \text{si } ICV \leq 0.4\\[3pt]
\dfrac{ICV - 0.4}{0.3}, & \text{si } 0.4 < ICV \leq 0.7\\[6pt]
1, & \text{si } ICV > 0.7
\end{cases}
\label{eq:mu-icv-alto}
\end{equation}
...
Indica la eficiencia del flujo vehicular:

\begin{equation}
\mu_{\text{Ineficiente}}(PI) =
\begin{cases}
1, & \text{si } PI \leq 0.3\\[3pt]
\dfrac{0.5 - PI}{0.2}, & \text{si } 0.3 < PI \leq 0.5\\[6pt]
0, & \text{si } PI > 0.5
\end{cases}
\label{eq:mu-pi-inef}
\end{equation}
...
\begin{cases}
0, & \text{si } PI \leq 0.3\\[3pt]
\dfrac{PI - 0.3}{0.2}, & \text{si } 0.3 < PI \leq 0.5\\[6pt]
\dfrac{0.8 - PI}{0.3}, & \text{si } 0.5 < PI \leq 0.8\\[6pt]
0, & \text{si } PI > 0.8
\end{cases}
\label{eq:mu-pi-mod}
\end{equation}
...
\begin{cases}
0, & \text{si } PI \leq 0.5\\[3pt]
\dfrac{PI - 0.5}{0.3}, & \text{si } 0.5 < PI \leq 0.8\\[6pt]
1, & \text{si } PI > 0.8
\end{cases}
\label{eq:mu-pi-muyef}
\end{equation}
...
\textbf{Ajuste de Tiempo Verde (\(\Delta T_{verde}\))}
...
\begin{cases}
1, & \text{si } \Delta T \leq -30\%\\[3pt]
\dfrac{-10\% - \Delta T}{20\%}, & \text{si } -30\% < \Delta T \leq -10\%\\[6pt]
0, & \text{si } \Delta T > -10\%
\end{cases}
\end{equation}
...
\begin{cases}
0, & \text{si } \Delta T \leq -30\%\\[3pt]
\dfrac{\Delta T + 30\%}{20\%}, & \text{si } -30\% < \Delta T \leq -10\%\\[6pt]
\dfrac{-5\% - \Delta T}{5\%}, & \text{si } -10\% < \Delta T \leq -5\%\\[6pt]
0, & \text{si } \Delta T > -5\%
\end{cases}
\end{equation}
...
\begin{cases}
0, & \text{si } \Delta T \leq -10\%\\[3pt]
\dfrac{\Delta T + 10\%}{10\%}, & \text{si } -10\% < \Delta T \leq 0\%\\[6pt]
\dfrac{10\% - \Delta T}{10\%}, & \text{si } 0\% < \Delta T \leq 10\%\\[6pt]
0, & \text{si } \Delta T > 10\%
\end{cases}
\end{equation}
...
\begin{cases}
0, & \text{si } \Delta T \leq 5\%\\[3pt]
\dfrac{\Delta T - 5\%}{10\%}, & \text{si } 5\% < \Delta T \leq 15\%\\[6pt]
\dfrac{30\% - \Delta T}{15\%}, & \text{si } 15\% < \Delta T \leq 30\%\\[6pt]
0, & \text{si } \Delta T > 30\%
\end{cases}
\end{equation}
...
\begin{cases}
0, & \text{si } \Delta T \leq 15\%\\[3pt]
\dfrac{\Delta T - 15\%}{15\%}, & \text{si } 15\% < \Delta T \leq 30\%\\[6pt]
1, & \text{si } \Delta T > 30\%
\end{cases}
\end{equation}
...
Para cada dirección \(d\), se calculan los grados de pertenencia aplicando las funciones de pertenencia definidas en las Ecuaciones~\ref{eq:mu-icv-bajo} a~\ref{eq:mu-ev}:

\begin{align}
\alpha_{ICV_{d}} &= \left[\, \mu_{\text{Bajo}}(ICV_{d}),\ \mu_{\text{Medio}}(ICV_{d}),\ \mu_{\text{Alto}}(ICV_{d}) \,\right]\\
\alpha_{PI_{d}} &= \left[\, \mu_{\text{Inef}}(PI_{d}),\ \mu_{\text{ModEf}}(PI_{d}),\ \mu_{\text{MuyEf}}(PI_{d}) \,\right]\\
\alpha_{EV_{d}} &= \left[\, \mu_{\text{Ausente}}(EV_{d}),\ \mu_{\text{Presente}}(EV_{d}) \,\right]
\end{align}

\textbf{Etapa 2: Aplicación de Reglas (Operador MIN)}

Para cada regla \(R_{i}\) con antecedente compuesto (conjunción ``Y''), se calcula el grado de activación mediante la t-norma del mínimo:

\begin{equation}
\alpha_{i} = \min\!\left(\mu_{\text{antecedente}_{1}},\ \mu_{\text{antecedente}_{2}},\ \ldots,\ \mu_{\text{antecedente}_{n}}\right)
\label{eq:min}
\end{equation}

\textbf{Etapa 3: Agregación de Consecuentes (Operador MAX)}

Los consecuentes activados, recortados a la altura \(\alpha_{i}\) de su regla (implicación de Mamdani), se agregan mediante la s-norma del máximo para formar la función de pertenencia resultante:

\begin{equation}
\mu_{\text{agregado}}(\Delta T) = \max_{i}\left(\, \min\!\left(\alpha_{i},\ \mu_{\text{consecuente}_{i}}(\Delta T)\right) \,\right)
\label{eq:max}
\end{equation}
...
\begin{equation}
\Delta T_{\text{verde}}^{*} = \frac{\displaystyle\int \Delta T \cdot \mu_{\text{agregado}}(\Delta T)\, d\Delta T}{\displaystyle\int \mu_{\text{agregado}}(\Delta T)\, d\Delta T}
\label{eq:centroide}
\end{equation}
...
\begin{equation}
\Delta T_{\text{verde}}^{*} = \frac{\displaystyle\sum_{i=1}^{M} \Delta T_{i} \cdot \mu_{\text{agregado}}(\Delta T_{i})}{\displaystyle\sum_{i=1}^{M} \mu_{\text{agregado}}(\Delta T_{i})}
\label{eq:centroide-disc}
\end{equation}
...
\begin{equation}
T_{\text{verde},d}(t) = T_{\text{base},d}\left(1 + \frac{\Delta T_{\text{verde},d}^{*}}{100}\right)
\label{eq:tverde}
\end{equation}
...
\begin{equation}
T_{\text{verde},\min} \;\leq\; T_{\text{verde},d}(t) \;\leq\; T_{\text{verde},\max}
\label{eq:tverde-restr}
\end{equation}
...
\begin{itemize}
\item
  \(T_{\text{verde},\min} = 10\)~s (mínimo para cruce peatonal seguro)
\item
  \(T_{\text{verde},\max} = 120\)~s (máximo para evitar acumulación excesiva en la dirección perpendicular)
\end{itemize}

Si el tiempo calculado viola alguna restricción, se aplica saturación (truncamiento):

\begin{equation}
T_{\text{verde},d}(t) \leftarrow
\begin{cases}
T_{\text{verde},\min}, & \text{si } T_{\text{verde},d}(t) < T_{\text{verde},\min}\\[3pt]
T_{\text{verde},\max}, & \text{si } T_{\text{verde},d}(t) > T_{\text{verde},\max}\\[3pt]
...
\begin{equation}
T_{\text{verde,NS}}(t) + T_{\text{verde,EO}}(t) + 2\,T_{\text{ámbar}} + 2\,T_{\text{todo\_rojo}} \;\leq\; T_{ciclo}
\label{eq:ciclo-restr}
\end{equation}

Si se viola esta restricción, se aplica normalización proporcional para preservar la relación entre fases:

\begin{equation}
T'_{\text{verde},d}(t) = T_{\text{verde},d}(t) \cdot \frac{T_{ciclo} - 2\,T_{\text{ámbar}} - 2\,T_{\text{todo\_rojo}}}{T_{\text{verde,NS}}(t) + T_{\text{verde,EO}}(t)}
\label{eq:balanceo}
\end{equation}

Esta normalización mantiene la proporción relativa entre las fases Norte--Sur y Este--Oeste mientras garantiza el cumplimiento del ciclo total. Nótese que el reparto proporcional preserva además las cotas de la Ecuación~\ref{eq:tverde-restr} siempre que el ciclo base sea factible, dado que el factor de escala es común a ambas fases y menor o igual que 1 en el caso de violación.

\subsection{Integración entre Control Difuso Local y Motor RL Global}\label{integraciuxf3n-entre-control-difuso-local-y-motor-rl-global}

El sistema implementa una arquitectura híbrida donde el control difuso local y el motor de Reinforcement Learning en Azure operan en escalas temporales complementarias: el control difuso local tiene como alcance las decisiones reactivas basadas en el estado local instantáneo (ciclo de decisión de segundos), mientras que el motor RL global realiza la optimización coordinada considerando el estado de red completo (ciclo de decisión de decenas de segundos a minutos).

\textbf{Regla de arbitraje entre ambos controladores}
...
\begin{cases}
T_{\text{verde},d}^{RL}(t), & \text{si } \exists\ \text{comando RL con } t - t_{RL} \leq T_{out} \ \land\ EV_{local} = 0\\[3pt]
T_{\text{verde},d}^{difuso}(t), & \text{caso contrario}
\end{cases}
\label{eq:arbitraje}
\end{equation}

donde \(t_{RL}\) es la marca temporal del último comando recibido desde Azure y \(T_{out} = 30\)~s el tiempo de validez del comando. Es decir: el comando global del motor RL tiene precedencia mientras esté vigente, pero ante pérdida de conectividad (comando expirado) o detección local de un vehículo de emergencia (que exige latencia mínima), el controlador difuso local asume el mando de inmediato. En todos los casos, la salida final atraviesa las restricciones de seguridad de las Ecuaciones~\ref{eq:tverde-restr} y~\ref{eq:ciclo-restr}, que actúan como capa de seguridad inviolable independiente de la fuente de la decisión.
...
\section{Motor de Decisión mediante Aprendizaje por Refuerzo}\label{motor-de-decisiuxf3n-mediante-aprendizaje-por-refuerzo}

El motor de decisión centralizado en Azure implementa un agente de Deep Reinforcement Learning que aprende políticas de control óptimas mediante la interacción continua con el entorno de tráfico. A diferencia de los sistemas de control tradicionales que siguen reglas fijas, este motor desarrolla estrategias adaptativas que maximizan el desempeño global de la red semafórica.
...
Para cada intersección \(I_{p}\) y cada dirección \(d \in \{N, S, E, O\}\), el agente decide el tiempo de fase verde dentro de un conjunto discreto de acciones:

\begin{equation}
a_{p,d}(t) \in \left\{\, T_{\text{base},d},\ \ T_{\text{base},d} + \Delta T,\ \ T_{\text{base},d} - \Delta T,\ \ \text{activar\_ola\_verde} \,\right\}
\label{eq:accion}
\end{equation}
...
\begin{itemize}
\item
  \(T_{\text{base},d}\): tiempo base de ciclo semafórico (por ejemplo, 60 segundos)
\item
  \(\Delta T\): incremento de ajuste (típicamente 10--15 segundos)
\item
  \(\text{activar\_ola\_verde}\): comando para coordinación con intersecciones vecinas
\end{itemize}

La acción global de la red concatena las decisiones de todas las intersecciones:

\begin{equation}
a(t) = \left[\, a_{1,N}(t),\ a_{1,S}(t),\ a_{1,E}(t),\ a_{1,O}(t),\ \ldots,\ a_{P,N}(t),\ a_{P,S}(t),\ a_{P,E}(t),\ a_{P,O}(t) \,\right]
\label{eq:accionglobal}
\end{equation}
...
\begin{equation}
R(s_{t}, a_{t}, s_{t+1}) = w_{1}\,R_{\text{throughput}} + w_{2}\,R_{\text{equidad}} + w_{3}\,R_{\text{emergencia}} + w_{4}\,R_{\text{suavidad}}
\label{eq:recompensa}
\end{equation}
...
\begin{equation}
R_{\text{throughput}}(t) = \frac{1}{4P}\sum_{p = 1}^{P}\ \sum_{d \in \{N, S, E, O\}}\left[\, q_{d}^{(p)}(t + 1) - q_{d}^{(p)}(t) \,\right]
\label{eq:rthroughput}
\end{equation}
...
\begin{equation}
R_{\text{equidad}}(t) = -\,\sigma\!\left(\, T_{\text{verde},1}(t),\ T_{\text{verde},2}(t),\ \ldots,\ T_{\text{verde},4P}(t) \,\right)
\label{eq:requidad}
\end{equation}
...
\begin{equation}
R_{\text{emergencia}}(t) = \sum_{p}\sum_{d}\left[\, EV_{d}^{(p)}(t) \cdot \left(1 - \frac{QL_{d}^{(p)}(t + 1)}{C_{\max,d}}\right) \,\right]
\label{eq:remergencia}
\end{equation}

Otorga recompensa alta cuando los vehículos de emergencia encuentran intersecciones con colas reducidas, incentivando al agente a crear olas verdes prioritarias para ambulancias y bomberos: el término entre paréntesis vale 1 cuando la cola en la dirección del vehículo de emergencia está vacía y decrece linealmente hasta 0 cuando está saturada.

\textbf{Suavidad de Control}

\begin{equation}
R_{\text{suavidad}}(t) = -\left\| a_{t} - a_{t - 1} \right\|^{2}
\label{eq:rsuavidad}
\end{equation}
...
En lugar de seleccionar determinísticamente una acción, el actor produce probabilidades que permiten exploración. Durante el entrenamiento, se muestrea de esta distribución (\(a_{p} \sim \pi_{\theta}\)) para explorar diferentes estrategias; durante la operación en producción, se selecciona la acción de mayor probabilidad (\(a_{p} = \arg\max_{a}\pi_{\theta}(a \mid s)\)).
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image5.png}
...
Una vez que el sistema ha sido entrenado, empieza a tomar decisiones por sí mismo en tiempo real. Primero analiza la situación completa del tráfico y, con ese análisis, decide cuál es la mejor acción posible en cada momento. Luego esa decisión general se divide en instrucciones específicas para cada intersección del sistema.

Después, esas instrucciones se traducen a comandos entendibles por los controladores de los semáforos, siguiendo un estándar internacional que asegura compatibilidad. Finalmente, estos comandos se envían de forma segura y rápida a los dispositivos instalados en cada intersección, que actualizan los tiempos de luz verde, coordinaciones y prioridades según lo decidido por el sistema.

\section{Predicción de Congestión mediante CNN-LSTM}\label{predicciuxf3n-de-congestiuxf3n-mediante-cnn-lstm}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image36.png}
...
\begin{align}
f_{t} &= \sigma\!\left(W_{f}\,[h_{t - 1},\ z_{t}] + b_{f}\right) && \text{(compuerta de olvido)}\label{eq:lstm-f}\\
...
h_{t} &= o_{t} \odot \tanh(c_{t}) && \text{(estado oculto)}\label{eq:lstm-h}
\end{align}
...
mediante Adam (tasa de aprendizaje \(10^{-3}\) con reducción ante estancamiento, lotes de 64, parada temprana con paciencia de 10 épocas sobre la pérdida de validación). Las métricas de evaluación sobre el conjunto de prueba son:

\begin{itemize}
\item
  \textbf{MAE (Mean Absolute Error)}: error promedio absoluto de las predicciones,
  \(\mathrm{MAE} = \frac{1}{N_{m}}\sum_{n}\left| \widehat{Y}_{n} - Y_{n} \right|\).
\item
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image39.png}
...
\begin{equation}
s_{\text{aumentado}}(t) = \left[\, s(t),\ \widehat{ICV}(t + 60\text{s}),\ \widehat{PI}(t + 60\text{s}) \,\right]
\label{eq:saumentado}
\end{equation}
...
Para el modelo CNN-LSTM se plantea un reentrenamiento programado cada domingo a las 2:00 a.m.\ (horario de mínima demanda vial y de cómputo), siguiendo el proceso ilustrado a continuación. El modelo recién entrenado solo reemplaza al modelo en producción si sus métricas sobre el conjunto de validación más reciente igualan o superan a las del modelo vigente, lo que protege al sistema contra degradaciones por derivas en los datos:

\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image78.png}
...
\begin{itemize}
\item
  Control activo: Envía comandos NTCIP cada 10s para ajustar semáforos
\item
  Emergencias: Activa ola verde cuando detecta vehículos prioritarios
\item
  Optimización: Calcula offsets entre semáforos para corredores coordinados
\item
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image65.png}
...
\begin{center}
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image58.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image10.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image115.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image81.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image128.png}
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image131.png}
...
\begin{itemize}
\item
  \textbf{Eliminación del controlador NTCIP dedicado:} La funcionalidad de control se integra completamente en el Raspberry Pi 5, eliminando la necesidad de hardware especializado adicional.
\end{itemize}
...
\chapter*{CONCLUSIONES Y OBSERVACIONES}\addcontentsline{toc}{chapter}{CONCLUSIONES Y OBSERVACIONES}\label{conclusiones-y-observaciones}

El desarrollo de este sistema de control semafórico adaptativo para Lima Metropolitana permitió comprobar que, cuando se integran varias tecnologías que normalmente se estudian por separado , visión por computadora, modelos predictivos y algoritmos de decisión, se pueden obtener mejoras concretas y medibles en la movilidad urbana. Las simulaciones en SUMO, aunque mejorables, mostraron una reducción del tráfico de al menos el 12\%, resultados que coinciden con lo que reporta la literatura internacional en aspectos de control similares aplicados para la red semafórica.

La combinación del control difuso local con la optimización por refuerzo a nivel global se comportó robustamente ante fallas de comunicación entre SUMO y la interfaz, este aspecto se considera relevante considerando que esto es considerado una limitante en soluciones basadas puramente en RL.

Aunque el proyecto se centró en una implementación a nivel de simulación y con herramientas accesibles, hubo resultados interesantes. Por ejemplo, la idea de coordinar vehículos de emergencia mostró que incluso modelos relativamente sencillos pueden representar mejoras potenciales en situaciones donde cada segundo cuenta. No significa que el sistema esté listo para operar en estos casos reales, pero sí sugiere que este tipo de lineamientos podría desarrollarse con más detalle en trabajos futuros.

En cuanto al componente económico, el trabajo permitió constatar que es posible plantear una solución de control semafórico inteligente sin recurrir a hardware especializado de alto costo. El uso de equipos como Raspberry Pi y servicios en la nube en configuraciones básicas mostró que existe un punto intermedio viable entre lo totalmente manual y las plataformas comerciales avanzadas. Esto, más que ser una demostración definitiva, sirve como indicio de que hay espacio para alternativas de menor presupuesto que podrían ser útiles en contextos municipales con recursos limitados como el caso de Lima Metropolitana.

Naturalmente, el sistema tiene limitaciones claras. La representación de intersecciones se mantuvo en un modelo general y no logró capturar la complejidad de escenarios con geometrías irregulares, carriles exclusivos o patrones atípicos de tráfico. Además, los modelos predictivos utilizados no incorporan aún situaciones inesperadas como accidentes o desvíos temporales, que en la práctica influyen mucho en el comportamiento real del tráfico. También persiste la dependencia de una conectividad estable para funciones que requieren comunicación remota, algo que no siempre está garantizado en todos los sectores de Lima.

En conjunto, el proyecto permitió comprender que, aun con recursos limitados y desde un enfoque académico, es posible aproximarse de manera práctica a los desafíos del control de tráfico urbano. La simulación en SUMO no reemplaza pruebas reales, pero ayuda a visualizar el impacto potencial y a identificar dónde concentrar esfuerzos si se quisiera avanzar hacia un piloto futuro. Más que ofrecer una solución definitiva, este trabajo sienta una base inicial y realista para seguir investigando cómo construir sistemas inteligentes de gestión del tránsito que nos permitan acercarnos a las técnicas de los países líderes en la materia, ajustadas a nuestro contexto socioeconómico.
...
\item
  Hikvision. (2022). DS-2CE57H0T-VPITF: Turbo HD camera {[}Hoja de datos{]}. \href{https://www.hikvision.com/content/dam/hikvision/usa/data-sheet/turbo-hd-cameras/DS-2CE57H0T-VPITFC-Black.pdf}{\ul{https://www.hikvision.com/content/dam/hikvision/usa/data-sheet/turbo-hd-cameras/DS-2CE57H0T-VPITFC-Black.pdf}}
\item
...
\textbf{Codificación Total en GitHub:}

\href{https://github.com/KevinT31/ControladorSemaforicoTFC}{\ul{https://github.com/KevinT31/ControladorSemaforicoTFC}}

https://github.com/KevinT31/ControladorSemaforicoTFC.git
...
\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image3.png}
\end{center}

\textbf{SECCIÓN E:}

\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image138.png}
\end{center}

\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image94.png}
\end{center}

\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image62.png}
\end{center}

\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image137.png}
\end{center}\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image32.png}
\end{center}\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image121.png}
\end{center}\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image59.png}
\end{center}

\textbf{SECCIÓN G:}

\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image34.png}
\end{center}\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image23.png}
\end{center}\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image142.png}
\end{center}

\textbf{SECCIÓN M:}

\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image135.png}
\end{center}\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image98.png}
\end{center}\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image38.png}
\end{center}\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image119.png}
\end{center}

\textbf{SECCIÓN V:}

\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image123.png}
\end{center}\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image63.png}
\end{center}\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image92.png}
\end{center}\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image4.png}
\end{center}

\textbf{SECCIÓN P:}

\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image129.png}
\end{center}

\textbf{SECCIÓN Z:}

\begin{center}
\includegraphics[width=0.92\linewidth,height=0.72\textheight,keepaspectratio]{./media/image106.png}
\end{center}
